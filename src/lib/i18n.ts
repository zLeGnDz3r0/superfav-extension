...
const es: Messages = {
  ...
  noSuperFavsSettingsDesc:
    'Márcalos en Twitch o Kick con el diamante y podrás gestionar sus avisos aquí.',
  liveLabel: 'Directo',
  titleLabel: 'Título',
  ...
  emptyNoFavsDesc:
    'Marca streamers con el botón de SuperFav en sus canales de Twitch o Kick y aparecerán aquí cuando estén en directo.',
...
const en: Messages = {
  ...
  noSuperFavsSettingsDesc: 'Mark them on Twitch or Kick with the diamond to manage alerts here.',
  liveLabel: 'Live',
  titleLabel: 'Title',
  ...
  emptyNoFavsDesc:
    'Mark streamers with the SuperFav button on Twitch or Kick and they will show up here when live.',
...
const ca: Messages = {
  ...
  noSuperFavsSettingsDesc: 'Marca’ls a Twitch o Kick amb el diamant i gestiona’n els avisos aquí.',
  liveLabel: 'Directe',
  titleLabel: 'Títol',
  ...
  emptyNoFavsDesc:
    'Marca streamers amb el botó SuperFav als seus canals de Twitch o Kick i apareixeran aquí quan estiguin en directe.',
...
const fr: Messages = {
  ...
  noSuperFavsSettingsDesc: 'Marquez-les sur Twitch ou Kick avec le diamant pour gérer les alertes ici.',
  liveLabel: 'Direct',
  titleLabel: 'Titre',
  ...
  emptyNoFavsDesc:
    'Marquez des streamers avec le bouton SuperFav sur Twitch ou Kick ; ils apparaîtront ici en direct.',
...
const it: Messages = {
  ...
  noSuperFavsSettingsDesc: 'Segnali su Twitch o Kick con il diamante e gestisci gli avvisi qui.',
  liveLabel: 'Live',
  titleLabel: 'Titolo',
  ...
  emptyNoFavsDesc:
    'Segna gli streamer con il pulsante SuperFav su Twitch o Kick e compariranno qui quando sono live.',
...
const de: Messages = {
  ...
  noSuperFavsSettingsDesc: 'Markiere sie auf Twitch oder Kick mit dem Diamanten und verwalte Hinweise hier.',
  liveLabel: 'Live',
  titleLabel: 'Titel',
  ...
  emptyNoFavsDesc:
    'Markiere Streamer mit dem SuperFav-Button auf Twitch oder Kick – sie erscheinen hier, wenn sie live sind.',
...
const tr: Messages = {
  ...
  noSuperFavsSettingsDesc: 'Twitch veya Kick’te elmasla işaretle; bildirimleri burada yönet.',
  liveLabel: 'Canlı',
  titleLabel: 'Başlık',
  ...
  emptyNoFavsDesc:
    'Twitch veya Kick’te SuperFav düğmesiyle işaretle; canlı olunca burada görünürler.',
...
const hi: Messages = {
  ...
  noSuperFavsSettingsDesc: 'Twitch या Kick पर हीरे से चिह्नित करें और यहाँ अलर्ट प्रबंधित करें।',
  liveLabel: 'लाइव',
  titleLabel: 'शीर्षक',
  ...
  emptyNoFavsDesc:
    'Twitch या Kick पर SuperFav बटन से चिह्नित करें; लाइव होने पर यहाँ दिखेंगे।',
...
const zh: Messages = {
  ...
  noSuperFavsSettingsDesc: '在 Twitch 或 Kick 用钻石标记，即可在此管理提醒。',
  liveLabel: '开播',
  titleLabel: '标题',
  liveAria: '{name} 的开播提醒',
  ...
  emptyNoFavsDesc: '在 Twitch 或 Kick 用 SuperFav 按钮标记主播，开播后会显示在这里。',
  errorTitle: '无法连接',
...
const ja: Messages = {
  ...
  noSuperFavsSettingsDesc: 'Twitch または Kick でダイヤを押して登録し、ここで通知を管理できます。',
  liveLabel: '配信',
  titleLabel: 'タイトル',
  liveAria: '{name} の配信通知',
  ...
  emptyNoFavsDesc:
    'Twitch または Kick の SuperFav ボタンで登録すると、配信中にここに表示されます。',
